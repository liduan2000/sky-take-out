...
//        vo.setPackageStr(jsonObject.getString("package"));
    ...
    public PageResult queryPage4User(int pageNum, int pageSize, Integer status) {
        ...
        // 分页条件查询
        Page<Order> page = orderMapper.queryPage(ordersPageQueryDTO);
...
//                    new BigDecimal(0.01));//原订单金额
    ...
    public PageResult conditionSearch(OrderPageQueryDTO orderPageQueryDTO) {
        ...
        Page<Order> page = orderMapper.queryPage(orderPageQueryDTO);
    ...
    public void rejection(OrderRejectionDTO orderRejectionDTO) throws Exception {
        // 根据id查询订单
        Order orderDB = orderMapper.getById(orderRejectionDTO.getId());
    ...
    public void cancel(OrderCancelDTO orderCancelDTO) throws Exception {
        // 根据id查询订单
        Order orderDB = orderMapper.getById(orderCancelDTO.getId());
